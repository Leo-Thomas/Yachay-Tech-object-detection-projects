...
1. Clone or download the **main repository** (Check the main repository's [README](https://github.com/Leo-Thomas/Yachay-Tech-object-detection-projects/blob/main/README.md))
